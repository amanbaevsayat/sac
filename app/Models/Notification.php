...
class Notification extends Model
{
    ...
    const TYPE_FIRST_SUBSCRIPTION_ERRORS = 3; // Ошибки первой подписки
    ...
    const TYPES = [
        ...
        self::TYPE_SUBSCRIPTION_ERRORS => 'Ошибки повторных подписок',
        self::TYPE_FIRST_SUBSCRIPTION_ERRORS => 'Ошибки первой подписки',
        self::TYPE_ENDED_SUBSCRIPTIONS_DT => 'Закончились абонементы (прям. перевод)',
        self::TYPE_ENDED_SUBSCRIPTIONS_DT_3 => 'Заканчиваются абоменты (прям. перевод)',
    ...
    const NOTIFICATION_TYPES = [
        ...
        self::TYPE_FIRST_SUBSCRIPTION_ERRORS,
