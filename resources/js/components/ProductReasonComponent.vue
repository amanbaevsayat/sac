<template>
    <div>
        <div class="input-group col-sm-3 nopadding" v-for="(item, index) in reasons" :key="index">
            <input class="form-control" v-model="reasons[index]" name="reasons[]">
        ...
        <button style="margin-top: 5px" class="btn btn-primary" type="button" @click="addItem">Добавить причину</button>
    </div>
</template>
